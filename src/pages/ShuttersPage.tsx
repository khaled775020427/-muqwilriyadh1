...
const ShuttersPage = () => {
  const shutterTypes = [
    {
      title: "سواتر قماش",
      description: "خفيفة ومرنة بألوان متعددة"
    },
    {
      title: "سواتر حديد",
      description: "قوية ومتينة طويلة العمر"
    },
    {
      title: "سواتر خشبية",
      description: "مظهر جمالي راقي"
    },
    {
      title: "سواتر بلاستيك",
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-6 animate-fade-in-up">
            ...
            <p className="text-xl md:text-2xl text-primary-foreground/90 max-w-3xl mx-auto leading-relaxed">
              تركيب سواتر قماش وحديد وبلاستيك وخشب بأعلى جودة وأفضل الأسعار
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div className="grid grid-cols-2 gap-4 animate-fade-in">
              ...
              />
              <img 
                src="https://images.unsplash.com/photo-1589939705384-5185137a7f0f?q=80&w=600" 
                alt="سواتر حديد"
            ...
            <div className="space-y-6 animate-fade-in-up">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                السواتر توفر لك الخصوصية والحماية مع لمسة جمالية للمكان:
              </p>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-accent flex-shrink-0 mt-1" />
                  <span className="text-foreground">حماية الخصوصية التامة</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-accent flex-shrink-0 mt-1" />
                  <span className="text-foreground">حماية من الرياح والغبار</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-accent flex-shrink-0 mt-1" />
                  <span className="text-foreground">تقليل أشعة الشمس المباشرة</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-accent flex-shrink-0 mt-1" />
                  <span className="text-foreground">تصاميم عصرية وجذابة</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-accent flex-shrink-0 mt-1" />
